...
<nav class="nav">
    ...
    <div class="nav_button">
        <li><button class="Signup"><a href="register.php">Sign Up</a></button></li>
        <li><button class="Login"><a href="login.php">Log In</a></button></li>
    </div>
</nav>
</header>
<body>
      <div class="wrapper">
        ...
        <section class="sidebar">
            ...
            <section class="temperature"><p>TEMPERATURE</p></section>
            <section class="qrcode"><p>QR CODE</p></section>
            <section class="facerecognition"><p>FACE RECOGNITION</p></section>
        </section>
      </div>
</body>
<footer>
