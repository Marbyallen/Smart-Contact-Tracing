  ...
  <body>
    <main>
      ...
      //
        ...
        // checkContent('Station', document.getElementById("station").value);
        // checkContent('Date', document.getElementById("date1").value);
        // checkContent('timeInputA.value', timeInputA.value);
        // checkContent('timeInputB.value', timeInputB.value);
